        	...
        	<div class="register">
               ...
               <!-- Busca Promotor -->
					...
					<?php if ($nivel=='BACHILLERATO'){?>
						<form id="escuela" name="escuela" method="post" action="index.php/admin/BachilleratoP">
					<?php }elseif ($nivel=='UNIVERSITARIOS'){?>
						<form id="escuela" name="escuela" method="post" action="index.php/admin/UniversidadP">
					<?php }?>
        		...
        		<div id="span12">
					<form role="form" action="index.php/admin/exportaExcel" method="post" target="_blank" id="FormularioExportacion">
						...
						<tr align="center">
								...
								<p>REPORTE DE BENEFICIARIOS  PROMOTORES  <?php if ($con!=12){echo $nivel.' - '.strtoupper($datos['delegacion']);}else echo $nivel.' -TODAS LAS DELEGACIONES';?> </p>  
