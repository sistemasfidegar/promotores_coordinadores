...
<base href="<?php echo base_url(); ?>">
 ...
 .btn-custom {
  ...
  filter: progid:DXImageTransform.Microsoft.gradient(startColorstr="#fc1bb1", endColorstr="#ed029f");
  background-image: -khtml-gradient(linear, left top, left bottom, from(#fc1bb1), to(#ed029f));
  background-image: -moz-linear-gradient(top, #fc1bb1, #ed029f);
  background-image: -ms-linear-gradient(top, #fc1bb1, #ed029f);
  background-image: -webkit-gradient(linear, left top, left bottom, color-stop(0%, #fc1bb1), color-stop(100%, #ed029f));
  background-image: -webkit-linear-gradient(top, #fc1bb1, #ed029f);
  background-image: -o-linear-gradient(top, #fc1bb1, #ed029f);
  background-image: linear-gradient(#fc1bb1, #ed029f);
  border-color: #ed029f #ed029f hsl(320, 98%, 45%);
  color: #333 !important;
		...
		<div class="row">
        	...
        	<!-- end Busca Promotor -->
					...
					<?php if($registro==1){
						...
						<table width="" border="1" class= "table table-bordered table-striped table-hover table-condensed" id="Exportar_a_Excel">
							<tr align="center">
								
								<th colspan="9" class="align-right">
								REPORTE DE BENEFICIARIOS ACEPTADOS COMO COORDINADOR  
						...
						<table width="" border="1" class= "table table-bordered table-striped table-hover table-condensed" id="Exportar_a_Excel">
							<tr align="center">
								...
								<th colspan="9" class="align-right">
								<p>REPORTE DE BENEFICIARIOS ACEPTADOS COMO PROMOTOR</p>  
									<?php //echo getMesesTrimestreLetra($trimestre);?><?php //echo$anio;?>
								</th>
							</tr>
							<tr>
							...
							<tr>
								...
								<td><?php echo $val['lugar_apoyo']?></td>
								<td><?php if($val['eje_1']==2){echo 'Arte y Cultura';}elseif($val['eje_1']==3){echo'Ciencia y tecnología';}elseif($val['eje_1']==4){echo'Deporte y recreación';}elseif($val['eje_1']==5){echo'Economía solidaria';}elseif($val['eje_1']==6){echo'Medio ambiente';}elseif($val['eje_1']==7){echo'Participación juvenil';}elseif($val['eje_1']==8){echo'Salud';} ?></td>
								<td><?php echo $val['actividad_1']?></td>
								<td><?php echo $val['correo']?></td>
								<td><?php echo $val['telefono']?></td>
							</tr>
								<?php 
