...
<html>
    <head>
        ...
        <title>Registros Promotor-Coordinador</title>
    ...
    <body style="background-image:url('<?php echo base_url(); ?>resources/images/bici.jpg'); background-repeat: no-repeat no-repeat; background-size:cover; background-attachment:fixed;">
        <!-- <body> -->
        <br>
        <div>
        ...
        <div style="text-align:center; margin-top:9%;">
            ...
            <center>
                ...
                <div class="transbox" style="border: 1px solid #9D9CA1;">
                    <h1>Registro de promotores y coordinadores <h2> Programa "Prepa Sí"</h2></h1>
                    <h2>(administrador)</h2>
