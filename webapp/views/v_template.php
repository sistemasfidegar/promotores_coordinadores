...
<html>
    <head>
        ...
        <meta charset="UTF-8">
        <title>Tablero Jefatura GDF</title>
    ...
    <body class="skin-blue">
        ...
        <header class="header">
            <a href="../../<?php echo base_url(); ?>/index.php/jefeGDF/index" class="logo">
                <!-- Add the class icon to your logo image or logo icon to add the margining -->
                Tablero Jefatura GDF
            </a>
            ...
            <aside class="left-side sidebar-offcanvas">
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        <li class="active">
                            <a href="<?php echo base_url(); ?>index.php/jefeGDF/index">
                                <i class="fa fa-dashboard"></i> <span>Principal</span>
                            </a>
                        </li>
                        <li>
                            <a href="<?php echo base_url(); ?>index.php/jefeGDF/index">
                                <i class="fa fa-microphone"></i> <span>Discursos</span>
                            </a>
                        </li>
                        <li>
                            <a href="<?php echo base_url(); ?>index.php/jefeGDF/index">
                                <i class="fa fa-users"></i> <span>Comites</span>
                            </a>
                        </li>
                        <li>
                            <a href="<?php echo base_url(); ?>index.php/jefeGDF/index">
                                <i class="fa fa-book"></i> <span>Programas</span>
                            </a>
                        </li>                        
                        <li>
                            <a href="<?php echo base_url(); ?>index.php/jefeGDF/index">
                                <i class="fa fa-hand-o-right"></i> <span>Asignaciones</span>
                            </a>
                        </li>  
                    </ul>
                </section>
