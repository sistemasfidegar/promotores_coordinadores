        		...
        		<div style="text-align:left; padding-left:20px; border-bottom: 2px dotted #bbb; min-height:73px;">
										...
										<div class="container">
											<a href="index.php" class="brand">Prepa Sí</a>
												<ul class="nav pull-right">
													...
													<li class="dropdown">
											          <a href="#" class="dropdown-toggle nav-stacked" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Administradoristrador<span class="caret"></span></a>
               	...
               	<!-- Busca Promotor -->
               		<div class="span12">
						...
						<form id="escuela" name="escuela" method="post" action="index.php/administrador/BachilleratoC">
					<?php }elseif ($nivel=='UNIVERSITARIOS'){?>
						<form id="escuela" name="escuela" method="post" action="index.php/administrador/UniversidadC">
					<?php }?>
