...
<body>
	<div class="register-container container">
		<div class="row">
        		...
        		<div style="text-align:left; padding-left:20px; border-bottom: 2px dotted #bbb; min-height:73px;">
							...
							<div class="span12">
								<div class="navbar">
									<div class="navbar-inner">
										<div class="container">
											<a href="index.php/administrador/index" class="brand">Prepa Sí</a>
               	...
               	<!-- Busca Promotor -->
               		...
               		<?php if ($nivel=='BACHILLERATO'){?>
						<form id="escuela" name="escuela" method="post" action="index.php/administrador/BachilleratoP">
					<?php }elseif ($nivel=='UNIVERSITARIOS'){?>
						<form id="escuela" name="escuela" method="post" action="index.php/administrador/UniversidadP">
					<?php }?>
							
								<h3>BUSQUEDA PROMOTORES <?php echo $nivel;?></h3>
        	...
        	<?php 
        	//print_r($datos);
        		if(isset($Promotor) && $Promotor!=null){ 
        		...
        		<div id="span12">
					<form role="form" action="index.php/administrador/exportaExcel" method="post" target="_blank" id="FormularioExportacion">
						...
						<tr align="center">
								...
								<p>REPORTE DE BENEFICIARIOS  PROMOTORES  <?php echo $nivel.' - '.strtoupper ($datos['delegacion']);?> </p>  
